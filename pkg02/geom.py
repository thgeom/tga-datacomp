...
proj2utm = Transformer.from_crs(crs_WGS84, crs_UTM47, always_xy=True, accuracy=0.01)
proj2geo = Transformer.from_crs(crs_UTM47, crs_WGS84, always_xy=True, accuracy=0.01)
proj3857to32647 = Transformer.from_crs(crs_3857, crs_UTM47, always_xy=True, accuracy=0.01)
...
def bbox_mer2utm(b_box):
    ll = proj3857to32647.transform(b_box[0], b_box[1])
    ur = proj3857to32647.transform(b_box[2], b_box[3])
    return ll + ur
#-----------------
